...
type Props = {
  tags: string[];
  data: CollectionEntry<"records">[];
};

export default function Records({ data, tags }: Props) {
  const [filter, setFilter] = createSignal(new Set<string>());
  const [records, setRecords] = createSignal<CollectionEntry<"records">[]>([]);
      ...
      <div class="col-span-3 sm:col-span-2">
        <div class="flex flex-col">
          <div class="text-sm uppercase mb-2">
            SHOWING {records().length} OF {data.length} RECORDS
          </div>
