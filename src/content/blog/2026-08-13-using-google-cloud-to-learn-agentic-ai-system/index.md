...
summary: Agentic AI 에 대해 더 자세히 알고 싶어 Google Cloud쪽에서 제공하는 유튜브나 강의들로 공부하려고 합니다.
...
image: /images/blog/google-cloud-agent-learning.png
---
![Google Cloud Agent learning.png](/images/blog/google-cloud-agent-learning-1.png)
...
그래서 강의 따라 Google Cloud에서 따라서 진행해보고 있네요. Annie Wang이 진행한 강의들이 다 좋다고 유튜브에서 찾아서 더 공부해나갈것 같네요.



C++와 더불어서 관심있지만 공부하지 못했던 부분을 채워나가는 과정이 재미있는것 같아요. 